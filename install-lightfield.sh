...
install ${VERBOSE} -DT -m 644 -o lumen system-stuff/lumen-bash_profile                 /home/lumen/.bash_profile
install ${VERBOSE} -DT -m 644 -o lumen system-stuff/lumen-real_bash_profile            /home/lumen/.real_bash_profile
install ${VERBOSE} -DT -m 600 -o lumen gpg/pubring.gpg                                 /home/lumen/.gnupg/pubring.gpg
install ${VERBOSE} -DT -m 600 -o lumen gpg/trustdb.gpg                                 /home/lumen/.gnupg/trustdb.gpg
